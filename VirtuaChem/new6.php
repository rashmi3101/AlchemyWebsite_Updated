...
<div id="topmenu" style="height:165px;width:1300px;text-align:center;" >
         <div id="main" style="background-color:yellow;height:165px;width:1150px ;float:left;text-align:center;" onmouseover="updtprice(document.getElementById('reactant').value)">
...
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp				<img src="6.jpg" id="6" width="20" height="20" onclick="put16()">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		&nbsp&nbsp&nbsp	&nbsp&nbsp		<img src="7.jpg" id="7" width="20" height="20" onclick="put17()">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		 ...
		 <span id="countdown" style="background-color:red ;height:165px;width:150px ;float:right;text-align:center;" onmouseover="updtprice(document.getElementById('reactant').value)">
...
<form>
						&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	<input type="number" id="gross" size="2" value="40000" >
...
<div id="newsmenu" style="height:45px;width:1000px;text-align:center;" onmouseover="updtprice(document.getElementById('reactant').value)">
...
<div id="rightmenu" style="background-color:#FFD700;height:450px;width:150px;float:right;" onmouseover="updtprice(document.getElementById('reactant').value)">
Demo version.
<!--
